    ...
    if (isset($_REQUEST['action'])) {
        ...
        if ($_REQUEST['action'] == "connexion") {
            ...
            if (isset($_POST)) {
                ...
                move_uploaded_file($file,ROOT.'public'.DIRECTORY_SEPARATOR.'uploads');
                $data = array(
                    'nom' => $nom,
                    'prenom' => $prenom,
                    'login' => $login,
            ...
            if (isset($_POST)) {
                ...
                $file = $_POST['file'];
                validInscription($prenom, $nom, $login, $password1, $password2, $file);
                move_uploaded_file($files,ROOT.'public'.DIRECTORY_SEPARATOR.'uploads');
                $data = array(
                    'nom' => $nom,
                    'prenom' => $prenom,
                    'login' => $login,
...
{
    ob_start();
    require_once(PATH_VIEWS . 'securite' . DIRECTORY_SEPARATOR . 'creerQuestion.html.php');
